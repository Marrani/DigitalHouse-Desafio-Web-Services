package com.gabrielmarrani.marvel.comics.viewmodel
...
class ComicsViewModel(val _repository: ComicsRepository) : ViewModel() {
    ...
    class ComicViewModelFactory(private val _repository: ComicsRepository): ViewModelProvider.Factory {
